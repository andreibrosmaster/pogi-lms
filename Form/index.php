    ...
    <video autoplay loop muted>
      ...
      Your browser does not support the video tag.
        ...
        <form id="login" class="input-group" name="form-login" action="db_connection.php" method="POST">
            ...
            <input type="password" class="input-field" placeholder="Password" name="login_password" id="myInput" required>
            <input type="checkbox" class="checkbox" onclick="myFunction()"><span class="span-btn" name="login_remember" >Show Password</span>
