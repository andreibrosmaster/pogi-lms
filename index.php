...
if (mysqli_num_rows($result) > 0) {
    ...
    $sql_query = "SELECT * FROM header WHERE id = 1;";
    $resulta = mysqli_query($conn, $sql_query);
    $school_name = 'No Name Found';
  ...
  <section class="section main-banner" id="top" data-section="section1">
      <video autoplay muted loop id="bg-video">
          <source src="<?php echo "Form/lms/landing_page/$video" ?>" type="video/mp4" />
      </video>
      ...
      <div class="video-overlay header-text">
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
                <div class="caption">
                  <h2>Ready To Learn With<br> Your <font color ="#FF2E2E">Nice </font>Choice?</h2>
